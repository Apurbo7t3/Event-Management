...
from participant.views import participant_home,profile,participant_category_filter,participant_search_filter,participant_dashboard
...
urlpatterns = [
    ...
    path('participant-profile/',profile,name='participant-profile'),
